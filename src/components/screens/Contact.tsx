...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="w-full min-h-screen bg-transparent text-white flex flex-col justify-center items-center relative overflow-hidden"
    ...
    >
      ...
      <AnimatePresence>
        {toast.show && (
          <motion.div
            ...
            className={`fixed top-8 right-6 z-50 rounded-2xl border backdrop-blur-2xl flex items-start gap-4 max-w-md ${
              toast.type === 'success'
      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col justify-center gap-8 my-auto">
        ...
        {/* Main Content Layout */}
        <div className="flex flex-col lg:flex-row items-stretch justify-between gap-8 lg:gap-14 w-full">

          {/* Left Side: Dynamic Live Terminal Process Monitor (Desktop Focus) */}
          <div className="hidden lg:flex w-1/2 flex-col justify-center">
            ...
            >
              ...
              {/* Terminal Title Bar */}
              <div 
                className="bg-slate-950/60 border-b border-white/10 flex items-center justify-between"
              ...
              >
                ...
                <div className="flex items-center gap-1.5 text-[10px] font-mono text-teal-300/80">
              ...
              <div 
                className="flex flex-col gap-5 my-auto font-mono text-xs"
                style={{ padding: '32px 36px' }}
              >
                
                {/* Header Badge */}
                <div className="flex items-center justify-between border-b border-white/10 pb-3.5">
                  <span className="text-[10px] text-teal-400 uppercase tracking-widest font-bold">Process Monitor</span>
                ...
                <div 
                  className="bg-slate-950/80 border border-white/10 rounded-2xl flex flex-col gap-2.5 min-h-[170px] justify-center"
                  style={{ padding: '20px 24px' }}
                >
                  {terminalStatus === 'idle' && (
                    <>
                      ...
                      <div className="flex items-center gap-1 mt-2 text-slate-500 text-[11px]">
                        <span>Ready when you are</span>
                        <span className="w-1.5 h-3 bg-teal-400 animate-pulse inline-block ml-1" />
                      </div>
                    </>
                  )}
                  ...
                  {terminalStatus === 'typing' && (
                    <>
                      ...
                      <div className="flex items-center gap-1 mt-2 text-amber-300/80">
                        <span>Capture in progress</span>
                        <span className="w-1.5 h-3 bg-amber-400 animate-pulse inline-block ml-1" />
                      </div>
                    </>
                  )}
              ...
              {/* Bottom Footer */}
              <div 
                className="bg-slate-950/40 border-t border-white/5 text-center text-[10px] font-mono text-slate-400"
          ...
          {/* Right Side: Form Card with Below-Form Terminal Status Monitor */}
          <div className="w-full lg:w-1/2 max-w-lg mx-auto flex flex-col gap-4">
            <div
              className="bg-white/5 border border-teal-500/20 rounded-3xl backdrop-blur-xl shadow-[0_0_30px_rgba(45,212,191,0.12)] hover:border-teal-400/40 transition-all duration-300"
              style={{ padding: '32px 36px' }}
            >
              <h3 className="text-lg sm:text-xl font-bold text-teal-400 font-['Cedarville_Cursive',cursive] text-center mb-5">
                Let&apos;s Work Together
              </h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                {/* Name Input */}
                <div>
                  <label className="text-[11px] font-bold uppercase tracking-wider text-teal-300/90 flex items-center gap-1.5 mb-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 focus:border-teal-400 rounded-xl text-xs sm:text-sm text-white placeholder-gray-400/60 focus:outline-none focus:ring-1 focus:ring-teal-400 transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 focus:border-teal-400 rounded-xl text-xs sm:text-sm text-white placeholder-gray-400/60 focus:outline-none focus:ring-1 focus:ring-teal-400 transition-all resize-none"
                    style={{ padding: '10px 14px' }}
                  />
                </div>
                ...
                <div className="mt-2 text-center">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full sm:w-auto rounded-xl bg-teal-400 hover:bg-teal-300 text-slate-950 font-bold text-xs transition-all shadow-[0_0_15px_rgba(45,212,191,0.3)] hover:shadow-[0_0_20px_rgba(45,212,191,0.5)] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mx-auto"
            ...
            {/* Below-Form Live Status Display (Visible Everywhere & Mobile-Friendly) */}
            <div 
              className={`border rounded-2xl backdrop-blur-xl transition-all duration-500 font-mono text-xs flex items-center justify-between ${
                terminalStatus === 'error'
